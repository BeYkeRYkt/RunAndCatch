 ...
 * Class for GameRoom
 */
public class GameRoomManagerOld : MonoBehaviourPunCallbacks, IOnEventCallback
{
    // Server properties
    ...
    public static GameRoomManagerOld Instance { get; private set; }
    ...
    public void OnEvent(EventData photonEvent)
    {
        ...
        else if (eventCode == EventConstant.EVENT_ID_ROOM_STOP_GAME)
        {
            ...
            ClientGameManagerOld gameManager = ClientGameManagerOld.Instance;
